...
public class BinanceApiClientFactory {
	...
	public BinanceApiSpotRestClient newSpotRestClient() {
		return new BinanceApiSpotRestClientImpl(apiKey, secret);
	}

	public BinanceApiLendingRestClient newLendingRestClient() {
		return new BinanceApiLendingRestClientImpl(apiKey, secret);
	}

	public BinanceApiCoinFuturesRestClient newCoinFuturesRestClient() {
		return new BinanceApiCoinFuturesRestClientImpl(apiKey, secret);
	}

	public BinanceApiUsdFuturesRestClient newUsdFuturesRestClient() {
		return new BinanceApiUsdFuturesRestClientImpl(apiKey, secret);
	}
}
